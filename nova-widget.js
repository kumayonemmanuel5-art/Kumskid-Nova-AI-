(function () {
  ...
  function initWidget() {
    ...
    // Load real bot config from Supabase if botId is not demo
    if (BOT_ID !== 'demo') {
      loadBotConfig();
    }
  }
    ...
    const messages = [
      {
        ...
        content: window._novaBotPrompt ||
          `You are a helpful AI assistant for ${BOT_NAME}. Answer customer questions professionally and helpfully. Be friendly and concise.`
      },
